...
$(document).ready(function() {
  $('#fullpage').fullpage({
    ...
    sectionsColor: ['none', 'none', 'none', 'none', 'none'],
  ...
  white.on('webkitAnimationStart oanimationstart msAnimationStart animationstart',
    function(e) {
  ...
  white.on('webkitAnimationEnd oanimationend msAnimationEnd animationend',
    function(e) {
...
function slider() {
  ...
  var item_width = $('.slider__inner li').outerWidth(); 
  var left_value = item_width * (-1);
  $('.slider__inner li:first').before($('.slider__inner li:last'));
  $('.slider__inner').css({'left' : left_value});
    
  $('.js-control-prev').click(function() {

    var tl = new TimelineLite( { paused : true });
    tl.add([
      TweenLite.to( $(".slider__inner > li:first-child") , 0.8 , { 
        x: item_width,
        ease: Power2.easeInOut,
        onComplete: function() {
          TweenLite.to( $(".slider__inner > li:first-child") , 0 , { 
            x: 0, 
          });
          $('.slider__inner li:first').before($('.slider__inner li:last'));
          TweenLite.to( $(".slider__inner > li:first .slide__image") , 0 , { 
            x: '80%', 
          });
          TweenLite.to( $(".slider__inner > li:nth-child(3) .slide__image") , 0 , { 
            x: '-80%', 
          });
          $(".slider__inner > li:first").removeClass('slide--right').addClass('slide--left');
          $(".slider__inner > li:nth-child(2)").removeClass('slide--left');
          $(".slider__inner > li:nth-child(3)").addClass('slide--right');
        }
      }),
      TweenLite.to( $(".slider__inner > li:first > .slide__image") , 0.8 , { 
        x: "0%",
        ease: Power2.easeInOut,
      })
    ]);
  ...
  $('.js-control-next').click(function() {

    var tl = new TimelineLite( { paused : true });
    tl.add([
      TweenLite.to( $(".slider__inner > li:nth-child(3)") , 0.8 , { 
        x: left_value, 
        ease: Power2.easeInOut,
        onComplete: function() {                    
          TweenLite.to( $(".slider__inner > li:nth-child(3)") , 0 , { 
            x: 0,
          });
          $('.slider__inner li:last').after($('.slider__inner li:first')); 
          TweenLite.to( $(".slider__inner > li:last .slide__image") , 0 , { 
            x: '-80%', 
          });
          TweenLite.to( $(".slider__inner > li:first .slide__image") , 0 , { 
            x: '80%', 
          });
          $(".slider__inner > li:nth-child(2)").removeClass('slide--right');
          $('.slider__inner li:last').removeClass('slide--left').addClass('slide--right');
          $('.slider__inner li:first').addClass('slide--left');
        } 
      }),
      TweenLite.to( $(".slider__inner > li:nth-child(3) > .slide__image") , 0.8 , { 
        x: "0%", 
        ease: Power2.easeInOut,
      })
    ]);
